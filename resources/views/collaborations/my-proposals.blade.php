                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="custom-modal-body modal-body">
                            <form method="post" action="{{ route('proposals.updateByInfluencers', $proposal->id) }}" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="form-container">
{{--                                    Hidden input to pass the collaboration id related to the proposal--}}
                                    <input type="hidden" name="collaboration_id" value="{{ $proposal->collaboration_id }}">
