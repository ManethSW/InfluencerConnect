    ...
    <ul class="nav-body navbar-nav">
        ...
        @else
            ...
            <div class="nav-body-content">
                ...
                <div>
                    <button id="dropdownAvatarNameButton" data-dropdown-toggle="dropdownAvatarName"
                        ...
                        <div class="pr-2">
                            ...
                            @else
                                <img class="w-8 h-8 me-2 rounded-full" src="{{ Auth::user()->avatar }}" alt="user photo">
                            @endif
                        </div>
                        {{ Auth::user()->name }}
                        <div class="px-2">
                    ...
                    <div id="dropdownAvatarName"
                        ...
                        <div class="dropdown-links" aria-labelledby="dropdownInformdropdownAvatarNameButtonationButton">
                            ...
                            @endif
                            <a href="#"
                                class=" hover:bg-gray-200 dark:hover:bg-gray-600 dark:hover:text-white">Settings</a>
                            <a href="#"
                ...
                {{-- <li class="dropdown">
                        <a id="navbarDropdown" class="user-dropdown dropdown-toggle" href="#" role="button"
